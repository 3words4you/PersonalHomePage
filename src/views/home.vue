    ...
    <div class="home_page">
      <div class="left_box">
        <div class="content_box">
          ...
          <div class="content_box_role_box">
      ...
      <div class="right_box">
        <div class="content_box">
          ...
          <div class="content_box_desc">
            ...
            <p class="content_box_desc_text">
              Find out more on my <a @click="openNewWindow('https://qiniu.zoombin.com/Resume_YiMo_1535158710.pdf')">Resume</a> and <a @click="goToProjects">Projects</a> page.
            </p>
